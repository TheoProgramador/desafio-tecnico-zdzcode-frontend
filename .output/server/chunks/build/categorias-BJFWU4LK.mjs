globalThis.__timing__.logStart('Load chunks/build/categorias-BJFWU4LK');import { u as useCategories, _ as _sfc_main$2, a as _sfc_main$1$1, b as _sfc_main$3, c as useApiError } from './useCategories-BYF4e-XE.mjs';
  ...
  setup(__props, { emit: __emit }) {
    ...
    watch(
      ...
      () => {
        ...
        form.nome = (_b = (_a = props.category) == null ? void 0 : _a.nome) != null ? _b : "";
        form.descricao = (_d = (_c = props.category) == null ? void 0 : _c.descricao) != null ? _d : null;
      },
      { immediate: true }
    );
...
export { _sfc_main as default };;globalThis.__timing__.logEnd('Load chunks/build/categorias-BJFWU4LK');
//# sourceMappingURL=categorias-BJFWU4LK.mjs.map
